...
using Telegram.Bot;
using TelegramContentusBot.Handlers.Chanels;
using TelegramContentusBot.Handlers.Channels.Details;
using TelegramContentusBot.Handlers.Posts;
...
builder.Services.AddScoped<ICallbackHandler, MyChannelsCalllbackHandler>();
builder.Services.AddScoped<ICallbackHandler, GenPostCallbackHandler>();
